...
const UserSetting = () => {
  ...
  const UserData = [
    {
      email: "rajnishcook@gmail.com",
      phoneNumber: "9904718717",
      userName: "RAJNISH",
      role: "Receptionist",
    },
    {
      email: "nagin@gmail.com",
      phoneNumber: "9316330276",
      userName: "nagin",
      role: "Receptionist",
    },
    {
      email: "sparshkalol@gmail.com",
      phoneNumber: "",
      userName: "Sparsh diagnostics",
      role: "Admin",
    },
  ];
  // --- Pagination States ---
  ...
  const handleUserMasterForm = () => {
    navigate("/setting/usersetting/create");
  };
  return (
    <>
      <div className="w-auto h-auto bg-white border border-gray-100 rounded-md shadow-xl/15 overflow-y-auto flex flex-col">
        ...
        <div className="flex justify-end">
          <div className="text-end mr-5">
            <button className="bg-[#7367f0] text-white font-medium p-2 rounded-lg cursor-pointer hover:bg-[#5b4ed3]">
              Import User
            </button>
          </div>
          <div className="text-end mr-5">
        ...
        <table className="w-full text-start border border-gray-200 mt-3">
          <thead className="bg-gray-100 text-gray-500">
            <tr className="border-b border-gray-200">
              ...
              <th className="py-2 px-4 text-start">Phone Number</th>
          ...
          <tbody className="text-gray-600">
            {currentRows.map((acc, index) => (
              ...
              >
                ...
                <td className="py-2 px-4">{acc.phoneNumber}</td>
        ...
        <div className="flex items-center justify-between p-3">
          <div className="text-gray-400">
            ...
            {Math.min(indexOfLastRow, UserData.length)} of {UserData.length}{" "}
            entries
          </div>
